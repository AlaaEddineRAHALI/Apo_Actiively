...
function Header({ isLogged, setIsLogged, setToken }) {
  ...
  return (
    <header className="appheader">
      ...
      <nav>
        ...
        {!isLogged && (
          <Link to="/login">
            <button type="button" className="appheader-button login-button">
              Connexion
            </button>
            <FontAwesomeIcon
              icon={faUser}
              size="2x"
              className="appheader-button-mobile"
            />
          </Link>
        )}
        ...
        <button
          type="button"
          className={`appheader-burger ${
            !isLogged ? "appheader-burger-loggedout" : ""
          } ${isBurgerOpen ? "appheader-burger-active" : ""}`}
          onClick={toggleBurger}
        >
          <Burger />
        </button>
