  ...
  return (
    <div className="container">
      ...
      <div className="container-form">
        ...
        <Form
          success
          className="ui form container-form"
          onSubmit={handleSubmit(onSubmit)}
        >
          <div className="label-select">
            <label className="label-form">URL de l&apos;image</label>
            <input
          ...
          <div className="label-select">
            <label className="label-form">Nom de l&apos;activité</label>
            <input
          ...
          <div className="field">
            <label className="label-select">
              ...
              <select
                id="day"
                {...register("day", {
                  required: "Ces champs sont obligatoire",
                })}
              >
            ...
            <label className="label-select">
              ...
              />
              {errors.start_time && (
                <p className="errors">{errors.start_time.message}</p>
              )}
            </label>
            <label className="label-select">
              ...
              />
              {errors.end_time && (
                <p className="errors">{errors.end_time.message}</p>
              )}
            </label>
          </div>
          <div className="label-select">
            <label className="label-form">Tarif</label>
            <input
          ...
          <div className="label-select">
            <label className="label-form">
              ...
              {errors.price_type && (
                <p className="errors">{errors.price_type.message}</p>
              )}
            </label>
          </div>
          <div className="label-select">
          ...
          {isSubmitSuccessful.form && (
            <p className="errors">{isSubmitSuccessful.form.message}</p>
          )}
        </Form>
      </div>
    </div>
